...
class Player(BaseModel):
    ...
    def compute_brawlers_stats(self):
        ...
        match self.trophies_over_1000:
            case x if x > 3000:
                self.trophies_box_id = 5
            case x if x >= 1000:
                self.trophies_box_id = 4
            case x if x >= 400:
                self.trophies_box_id = 3
            case x if x >= 100:
                self.trophies_box_id = 2
            case _:
                self.trophies_box_id = 1
